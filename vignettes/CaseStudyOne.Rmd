...
for(i in 1:length(netdats)){
  ...
  #t_net_mets[[i]]$flo[net_mets$tp==i]<-sna::flowbet(movenet[[2]][,,i])
...
We now conduct the statistical modelling of the observed dataset. This is done using glmmTMB. A bit of a spiel about what this is.
